...
export const Pill = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative bg-surface/80 transform-gpu font-medium text-muted backdrop-blur-xs font-mono text-sm inline-flex items-center justify-center px-3 h-8 border border-border [clip-path:polygon(var(--poly-roundness)_0,calc(100%_-_var(--poly-roundness))_0,100%_var(--poly-roundness),100%_calc(100%_-_var(--poly-roundness)),calc(100%_-_var(--poly-roundness))_100%,var(--poly-roundness)_100%,0_calc(100%_-_var(--poly-roundness)),0_var(--poly-roundness))]",
        className
      )}
    >
      <span
      ...
      <span className="inline-block size-2.5 rounded-full bg-primary mr-2 shadow-glow shadow-primary/40" />
